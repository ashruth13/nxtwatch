...
import {IoLogoLinkedin, IoIosDownload} from 'react-icons/io'
            ...
            <MainHead>
              ...
              <div className="koko">
                ...
                <div>
                  ...
                  <MainSaved dark={dark} Premium={showPremium}>
                    <div className="saved-f">
                      <IoIosDownload color="red" size={35} />
                      <h1 className="h11">Saved Videos</h1>
                    </div>
                    {savedItems.map(each => (
